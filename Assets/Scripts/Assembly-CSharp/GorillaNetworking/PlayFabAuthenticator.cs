...
namespace GorillaNetworking
{
	public class PlayFabAuthenticator : MonoBehaviour
	{
		...
		public void Awake()
		{
			PhotonNetwork.PhotonServerSettings.AppSettings.AppIdRealtime = "9a430955-bae5-4295-855d-8fb524900e69";
			PhotonNetwork.PhotonServerSettings.AppSettings.AppIdVoice = "d94cedfd-d71e-4470-8d5a-b8d605e6deb2";
			PhotonNetwork.PhotonServerSettings.AppSettings.AppVersion = "live1110";
			PlayFabSettings.TitleId = "1EB6F5";
			if (instance == null)
			{
				instance = this;
			}
