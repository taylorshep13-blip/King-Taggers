				...
				if (flag24)
				{
					...
					if (flag29)
					{
						...
						if (flag34)
						{
							...
							__instance.GetComponent<Rigidbody>().linearVelocity = Vector3.zero;
						...
						else
						{
							...
							if (flag40)
							{
								__instance.GetComponent<Rigidbody>().linearVelocity = __instance.headCollider.transform.forward * Time.deltaTime * 12f;
